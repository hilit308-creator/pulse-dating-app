...
import { loginWithPhone, apiCall } from '../../services/authApi';
...
const LoginPhoneScreen = () => {
  ...
  const handleSendCode = async () => {
    ...
    try {
      ...
      const result = await apiCall(loginWithPhone, fullPhone);
        ...
        >
          ...
          <Alert 
            ...
            sx={{ 
              ...
              '& .MuiAlert-icon': { color: '#6C5CE7' },
              '& .MuiAlert-message': { fontSize: '0.875rem', color: '#1a1a2e' },
            }}
          >
            This is for existing accounts only. If you don't have an account, please sign up first.
          </Alert>
